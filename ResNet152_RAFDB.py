...
VAL_SIZE = 0.2
TARGET_SIZE = (224, 224)  # ResNet-50 sử dụng kích thước 224x224
...
class ResNet52_Model(nn.Module):
    def __init__(self, num_classes):
        super(ResNet52_Model, self).__init__()
...
model = ResNet52_Model(num_classes=NUM_CLASSES)
...
# Tệp log
metrics_log_file = "ResNet152_RAFDB_metrics_log.csv"
confusion_matrix_log_file = "ResNet152_RAFDB_confusion_matrix_log.csv"
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    if val_f1 > best_f1:
        ...
        torch.save(model.state_dict(), "ResNet152_RAFDB_f1.pth")
    else:
        epochs_no_improve += 1
    ...
    if val_acc > best_acc:
        ...
        torch.save(model.state_dict(), "ResNet152_RAFDB_acc.pth")

    if val_loss < best_loss:
        best_loss = val_loss
        torch.save(model.state_dict(), "ResNet152_RAFDB_loss.pth")
