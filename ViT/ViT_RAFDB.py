...
# Tệp log
metrics_log_file = "vit_base_patch16_224_RAFDB_metrics_log.csv"
confusion_matrix_log_file = "vit_base_patch16_224_RAFDB_confusion_matrix_log.csv"
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    if val_f1 > best_f1:
        ...
        torch.save(model.state_dict(), "vit_base_patch16_224_RAFDB_f1.pth")
    else:
        epochs_no_improve += 1
    ...
    if val_acc > best_acc:
        ...
        torch.save(model.state_dict(), "vit_base_patch16_224_RAFDB_acc.pth")

    if val_loss < best_loss:
        best_loss = val_loss
        torch.save(model.state_dict(), "vit_base_patch16_224_RAFDB_loss.pth")
