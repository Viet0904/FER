...
# Configurations
MODEL_PATH = "MobileNetV3_FER2013_vs1_f1.pth"  # Đường dẫn tới checkpoint của MobileNetV3_Attention đã huấn luyện
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
NUM_CLASSES = 7
TARGET_SIZE = (224, 224)  # Kích thước đầu vào của MobileNetV3_Attention
BATCH_SIZE = 32

# Label mapping from CK+ to FER-2013 (theo nhãn của MobileNetV3_Attention)
...
# Define the MobileNetV3_Attention model (từ code mới)
...
class MobileNetV3_Attention(nn.Module):
    def __init__(self, num_classes):
        ...
        self.backbone = create_model("mobilenetv3_large_100", pretrained=False, features_only=True)
...
plt.tight_layout()
plt.savefig(
    "MobileNetV3_FER201_vs1_confusion_matrix_ckextended_raw.png",
    dpi=300,
    bbox_inches="tight",
)
print(
    "Raw confusion matrix saved to 'MobileNetV3_FER201_vs1_confusion_matrix_ckextended_raw.png'"
)
...
plt.tight_layout()
plt.savefig(
    "MobileNetV3_FER201_vs1_confusion_matrix_ckextended_normalized.png",
    dpi=300,
    bbox_inches="tight",
)
print(
    "Normalized confusion matrix saved to 'MobileNetV3_FER201_vs1_confusion_matrix_ckextended_normalized.png'"
)
...
cm_raw_df.to_csv("MobileNetV3_FER201_vs1_confusion_matrix_ckextended_raw.csv")
print(
    "Raw confusion matrix saved to 'MobileNetV3_FER201_vs1_confusion_matrix_ckextended_raw.csv'"
)
...
cm_normalized_df.to_csv(
    "MobileNetV3_FER201_vs1_confusion_matrix_ckextended_normalized.csv"
)
print(
    "Normalized confusion matrix saved to 'MobileNetV3_FER201_vs1_confusion_matrix_ckextended_normalized.csv'"
)
