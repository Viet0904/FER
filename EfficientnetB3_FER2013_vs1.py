...
VAL_SIZE = 0.2
TARGET_SIZE = (300, 300)  # EfficientNetB3 thường dùng input size nhỏ hơn, ví dụ 300x300
...
# Định nghĩa mô hình EfficientNetB3 với attention
class EfficientNetB3_Attention(nn.Module):
    def __init__(self, num_classes):
        super(EfficientNetB3_Attention, self).__init__()
...
# Khởi tạo mô hình EfficientNetB3
model = EfficientNetB3_Attention(num_classes=NUM_CLASSES)
...
# Tệp log
metrics_log_file = "EfficientNetB3_FER2013_vs1_metrics_log.csv"
confusion_matrix_log_file = "EfficientNetB3_FER2013_vs1_confusion_matrix_log.csv"
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    if val_f1 > best_f1:
        ...
        torch.save(model.state_dict(), "EfficientNetB3_FER2013_vs1_f1.pth")
    else:
        epochs_no_improve += 1
    ...
    if val_acc > best_acc:
        ...
        torch.save(model.state_dict(), "EfficientNetB3_FER2013_vs1_acc.pth")

    if val_loss < best_loss:
        best_loss = val_loss
        torch.save(model.state_dict(), "EfficientNetB3_FER2013_vs1_loss.pth")
