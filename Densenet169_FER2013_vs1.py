...
VAL_SIZE = 0.2
TARGET_SIZE = (224, 224)  # DenseNet169 thường dùng input size 224x224
...
# Định nghĩa mô hình DenseNet169 với attention
class DenseNet169_Attention(nn.Module):
    def __init__(self, num_classes):
        super(DenseNet169_Attention, self).__init__()
        self.backbone = timm.create_model(
            "densenet169", pretrained=True, features_only=True
        )
...
# Khởi tạo mô hình DenseNet169
model = DenseNet169_Attention(num_classes=NUM_CLASSES)
...
# Tệp log
metrics_log_file = "DenseNet169_FER2013_vs1_metrics_log.csv"
confusion_matrix_log_file = "DenseNet169_FER2013_vs1_confusion_matrix_log.csv"
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    if val_f1 > best_f1:
        ...
        torch.save(model.state_dict(), "DenseNet169_FER2013_vs1_f1.pth")
    else:
        epochs_no_improve += 1
    ...
    if val_acc > best_acc:
        ...
        torch.save(model.state_dict(), "DenseNet169_FER2013_vs1_acc.pth")

    if val_loss < best_loss:
        best_loss = val_loss
        torch.save(model.state_dict(), "DenseNet169_FER2013_vs1_loss.pth")
